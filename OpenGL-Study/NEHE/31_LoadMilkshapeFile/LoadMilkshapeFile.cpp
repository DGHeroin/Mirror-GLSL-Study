...
//}
/***********************************新添的代码***********************************************************************************/
GLuint LoadGLTexture( const char *filename )						// 载入纹理
{
	AUX_RGBImageRec *pImage;										// 创建保存图像的对象
	GLuint texture = 0;												// 纹理ID

	pImage = LoadBMP( filename );									// 载入纹理
...
int InitGL(GLvoid)										// 此处开始对OpenGL进行所有设置
{
	...
	//}
/***********************************新添的代码***********************************************************************************/
	pModel = new MilkshapeModel();									// 载入MS3D模型
